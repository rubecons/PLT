...
void FenetreNouvelElevage::enregistrerNouvelElevage ()
{
    ...
    {       
        ...
        default:
        {//*/
            std::shared_ptr<moteur::CommandeNouvelElevage> commandeNouvelElevage=std::make_shared<moteur::CommandeNouvelElevage>(ferme,nomElevage, ferme->getRaces()[indexRace-2], fenetrePrincipale, observer);
